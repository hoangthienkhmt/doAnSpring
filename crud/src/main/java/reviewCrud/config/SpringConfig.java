...
@Configuration
@EnableJpaRepositories(basePackages = "reviewCrud.repository")
...
public class SpringConfig {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/sach2");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManager.setPackagesToScan("reviewCrud.entity");
